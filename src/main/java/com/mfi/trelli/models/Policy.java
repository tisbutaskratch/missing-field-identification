...
public class Policy {
     ...
     */
    private Duration policyTermMonths;

    /**
     * Total premium (cost) for the term of the policy, in cents
     */
    private float premiumCents;
    ...
    public Duration getPolicyTermMonths() {
        return policyTermMonths;
    }

    public void setPolicyTermMonths(final Duration policyTermMonths) {
        this.policyTermMonths = policyTermMonths;
    }

    public float getPremiumCents() {
        return premiumCents;
    }

    public void setPremiumCents(final float premiumCents) {
